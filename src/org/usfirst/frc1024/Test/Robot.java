...
public class Robot extends IterativeRobot {
	...
	public static driveleft leftpid;
	public static driveright rightpid;
	...
	public void robotInit() {
		...
		leftpid = new driveleft();
		rightpid = new driveright();
		// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS

		driveleft.left.setInverted(true);
		driveright.right.setInverted(true);
	...
	public void autonomousPeriodic() {
		Scheduler.getInstance().run();
		while(isDone == false && isAutonomous()){
			...
			*/
			//Movement.driveStraightInches(50, -0.3);
			isDone = true;
		}
	...
	public void teleopPeriodic() {
		...
		//RobotMap.drivetrainleft.set(-oi.logi.getRawAxis(1)*1);
		//RobotMap.drivetrainright.set(-oi.logi.getRawAxis(3)*1); 
		RobotMap.myRobot.tankDrive(-oi.logi.getRawAxis(1), oi.logi.getRawAxis(3));
